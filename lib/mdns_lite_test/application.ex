defmodule MdnsLiteTest.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: MdnsLiteTest.Supervisor]

    children =
      [
        # Children for all targets
        # Starts a worker by calling: MdnsLiteTest.Worker.start_link(arg)
        # {MdnsLiteTest.Worker, arg},
      ] ++ children(target())
  ...
  def target() do
    Application.get_env(:mdns_lite_test, :target)
  end
